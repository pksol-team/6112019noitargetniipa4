                        ...
                        <div class="page-content-inner">
                            <div class="row">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <form action="channelsubmit.php" enctype="multipart/form-data" method="post" id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
                                           ...
                                           <div class="form-group">
                                                <label class="control-label col-md-3">channel Image Logo

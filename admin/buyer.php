                            ...
                            <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                                ...
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">buyer add-form</span>
                                    </div>
                                    ...
                                    <form method="post" action="import/import_dispatch.php" enctype="multipart/form-data" name="upload_excel" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="file" id="file" onchange="return fileValidation();" class="form-control" />
												
                                                <!-- Image preview -->
                                                
                                            </div>
                                            </div><br>
											<a href="eBay_Import.csv" download><span>demo.csv</span></a>

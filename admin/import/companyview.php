                                   ...
                                   <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
												...
												<td>
                                                   <a href="channeldelete.php?id=<?php echo $id;?>"> <button onClick="return confirm('Are you SURE you want to delete')" id="sample_editable_1_new" class="btn sbold red"> Delete

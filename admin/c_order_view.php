...
<?php
	...
	// curl_setopt($ch, CURLOPT_URL, "http://4-api.test/admin/unmerge.php?type=curl");
	// curl_setopt($ch, CURLOPT_POST, 1);
															...
															<table style="font-size: 12px;" class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		...
																		<td style="font-size:12px;" class="">
																			<div class=""><?php if(!empty($data_011['buyer_name'])){echo $data_011['buyer_name'];} ?></div>
																		</td>
																		<td style="font-size:12px;">
																			<div class=""><?php echo strtoupper($data_011['buyer_postcode']); ?></div>
																		</td>
																		<td style="font-size:12px;">																		
																			<table width="230px" border="1px  #fafafa; word-wrap: break-word;"><?php echo implode("", $skus); ?>
																			</table>
																		</td>
															...
															<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		...
																		<td style="font-size:12px;" class="">
																			<div class=""><?php if(!empty($data_0011['buyer_name'])){echo $data_0011['buyer_name'];} ?></div>
																		</td>
																		<td style="font-size:12px;">
																			<div class=""><?php echo strtoupper($data_0011['buyer_postcode']); ?></div>
																		</td>
																		<td style="font-size:12px;">
																			<table width="230px" border="1px  #fafafa; word-wrap: break-word;"><?php  echo implode("",$skus1); ?>
																			</table>
																		</td>
																		<td style="font-size:12px;" class=""><?php 

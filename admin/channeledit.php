                        ...
                        <div class="page-content-inner">
                            <div class="row">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
									<?php
									$data = mysqli_query($conn,"select * from `channel` where `id`='$id'");
									$datac= mysqli_fetch_assoc($data);
									
									?>
                                    <form action="channeleditsubmit.php?id=<?php echo $id; ?>" method="post" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label class="control-label col-md-3">channel Symbol
